...
def fit_one_epoch(net, epoch, epoch_size, epoch_size_val, gen, genval, Epoch, cuda):
    ...
    torch.save(model.state_dict(), 'densenet121/Epoch%d-Total_Loss%.4f-Val_Loss%.4f.pth' % (
...
if __name__ == "__main__":
    ...
    assert backbone in ["mobilenet", "resnet50", "vgg16", "resnet152", "densenet121"]
    ...
    # ------------------------------------------#
    # # 加快模型训练的效率
    # model_path = "mobilenet/Epoch100-Total_Loss0.1274-Val_Loss2.1611.pth"
    ...
    if True:
        ...
        Init_Epoch = 0  # 网络最开始训练的代数
        Freeze_Epoch = 50  # 网络冻结起来所需要训练的代数
